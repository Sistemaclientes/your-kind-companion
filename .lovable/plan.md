...
Verificar dominio de email. Se nao houver, sera necessario configurar um dominio de email primeiro. Depois configurar o envio de emails transacionais para os emails de reset.
