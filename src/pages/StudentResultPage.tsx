      ...
      <div className="relative z-10 w-full max-w-5xl px-6 pt-16 pb-12 flex flex-col items-center">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-black text-on-surface font-headline tracking-tight mb-6 leading-tight">
            Parabéns, <span className="text-primary">Ricardo Almeida!</span>
          </h1>
          <p className="text-lg md:text-xl text-on-surface-variant font-medium max-w-2xl mx-auto leading-relaxed">
            Você concluiu a avaliação de <span className="text-on-surface font-bold">Mestre de Obra</span> com um desempenho excepcional. Seu certificado já está disponível.
          </p>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="card-saas !p-10 flex flex-col items-center justify-center text-center group">
            ...
            <span className="text-7xl font-black text-primary font-headline mb-4 tracking-tighter">8,5</span>
            <div className="px-5 py-1.5 bg-primary/10 text-primary text-[10px] font-black rounded-full uppercase tracking-widest border border-primary/20">
              Aprovado
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="card-saas !p-10 flex flex-col items-center justify-center text-center group">
            ...
            <span className="text-[10px] font-bold text-on-surface-variant uppercase tracking-[0.2em] mb-4">Tempo Total</span>
            <div className="flex items-baseline gap-1 mb-4">
              <span className="text-7xl font-black text-on-surface font-headline tracking-tighter">48</span>
              <span className="text-3xl font-black text-on-surface-variant">m</span>
            </div>
            <span className="text-xs font-bold text-on-surface-variant uppercase tracking-widest">Média: 52min</span>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="card-saas !p-10 flex flex-col items-center justify-center text-center group">
            ...
            <div className="flex items-baseline gap-1 mb-4">
              <span className="text-7xl font-black text-on-surface font-headline tracking-tighter">17</span>
              <span className="text-3xl font-black text-on-surface-variant">/20</span>
            </div>
            <span className="text-xs font-bold text-on-surface-variant uppercase tracking-widest">85% de Precisão</span>
          </motion.div>
        </motion.div>
