        ...
        >
          ...
          <div className="space-y-6">
            <h1 className="text-5xl md:text-7xl font-black text-on-surface font-headline leading-[1.1] tracking-tighter">
              Prova Mestre <br/>
              de Obra <span className="text-primary">Civil</span>
            </h1>
            <p className="text-lg md:text-xl text-on-surface-variant leading-relaxed font-medium max-w-xl">
              Bem-vindo à sua avaliação profissional. Prepare-se para demonstrar seus conhecimentos técnicos em um ambiente controlado e seguro.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 max-w-md">
            <div className="card-saas !p-6 flex items-center gap-5 group">
              ...
              <div>
                <p className="text-3xl font-black text-on-surface font-headline tracking-tighter">20</p>
